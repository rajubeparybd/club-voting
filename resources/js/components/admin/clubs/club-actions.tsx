...
import CheckUserPermission from '../../ui/check-user-permission';
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                <CheckUserPermission
                    permission={['view_clubs', 'edit_clubs', 'delete_clubs']}
                    fallback={
                        <DropdownMenuItem>
                ...
                >
                    ...
                    <CheckUserPermission permission="delete_clubs">
                        <>
                            ...
                            <DropdownMenuItem onClick={() => onDelete(clubId)} className="text-red-600 focus:text-red-600" disabled={disabled}>
